...
function newButton(x,y,w,h,func,inpt){
	return buttons[buttons.length] = new button(x,y,w,h,func,buttons.length,inpt);
}

function newImageButton(image,x,y,w,h,func,inpt){
	return buttons[buttons.length] = new imageButton(image,x,y,w,h,func,buttons.length,inpt);
}
